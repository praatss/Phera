...
(() => {
  ...
  function configureLayout() {
    // Keep the cinematic/pinned story on normal tablet/desktop widths.
    // The old version disabled it for short browser windows and for a tiny
    // 2px content overflow, which made the effect disappear very easily.
    ...
    // Give the sticky story enough physical scroll distance for all scenes.
    story.style.setProperty('--story-length', `${Math.max(260, scenes.length * 105)}vh`);
